...
<template>
  <div>
    ...
    <div class="buttons">
      ...
      <button @click="stopProgress">Stop</button>
      <button @click="incProgress()">Increment</button>
      <button @click="doneProgress">Finish</button>
      <button @click="resetProgress">Reset</button>
      <button @click="setProgress(0.7)">Set 70%</button>
    </div>
  </div>
</template>
